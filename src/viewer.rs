// Original code: https://github.com/iced-rs/iced/blob/0.13.1/widget/src/image/viewer.rs
...
use iced::mouse;
use iced::{ContentFit, Element, Length, Pixels, Point, Radians, Rectangle, Size, Vector};
